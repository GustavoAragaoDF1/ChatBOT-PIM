...
if [ ! -d "/home/gustavoaragao/projects" ]; then
...
if [ -d "/home/gustavoaragao/projects/backend" ]; then
...
if [ -d "/home/gustavoaragao/projects/frontend/app" ]; then
...
case $opcao in
    1)
        ...
        cd /home/gustavoaragao/projects/backend
    ...
    2)
        ...
        cd /home/gustavoaragao/projects/frontend/app
    ...
    3)
        ...
        if command -v tmux &> /dev/null; then
            ...
            tmux send-keys -t chatbot:backend "cd /home/gustavoaragao/projects/backend && export ASPNETCORE_URLS='http://0.0.0.0:6660' && echo '🚀 Iniciando API Backend em http://192.168.1.113:6660' && dotnet run" Enter
            
            sleep 3
            
            # Janela 2 - Frontend
            tmux new-window -t chatbot -n frontend
            tmux send-keys -t chatbot:frontend "cd /home/gustavoaragao/projects/frontend/app && export ASPNETCORE_URLS='http://0.0.0.0:6661' && echo '🚀 Iniciando Web Frontend em http://192.168.1.113:6661' && dotnet run" Enter
            ...
            cd /home/gustavoaragao/projects/backend
            echo '🚀 Iniciando API Backend em http://192.168.1.113:6660'
            ...
            cd /home/gustavoaragao/projects/frontend/app
            echo '🚀 Iniciando Web Frontend em http://192.168.1.113:6661'
        ...
        echo -e "${BLUE}📍 URLs:${NC}"
        echo -e "   API Backend:   ${YELLOW}http://192.168.1.113:6660${NC}"
        echo -e "   Web Frontend:  ${YELLOW}http://192.168.1.113:6661${NC}"
        echo -e "   Swagger API:   ${YELLOW}http://192.168.1.113:6660/swagger${NC}"
        echo ""
